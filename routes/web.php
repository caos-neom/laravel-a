...
Route::get('/aluno/add/{nome}/{telefone}/{email}', [App\Http\Controllers\Aluno::class, 'principal'])->name('aluno.add');;
...
Route::get('/componente/listar', [App\Http\Controllers\Componentes::class, 'show'])->name('componente.show');
